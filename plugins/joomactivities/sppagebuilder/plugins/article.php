 ...
 *
 */
class plgJoomActivitiesContentArticle extends plgJoomActivities
{
    /**
    ...
    {
        parent::onJoomActivitiesAfterSave($context, $table, $is_new, false);
    ...
    {
        parent::onJoomActivitiesAfterDelete($context, $table, false);
