 ...
 *
 */
class plgJoomActivitiesContent extends JPlugin
{
    /**
     ...
     */
    public function onJoomActivitiesAfterSave($context, $table, $is_new)
    {
        // Unalias context
        ...
        // Process activity
        return $plugin->onJoomActivitiesAfterSave($context, $table, $is_new);
    }
     ...
     * @return    boolean                True on success, False on error
     */
    public function onJoomActivitiesAfterDelete($context, $table)
    {
        // Unalias context
        $this->unalias($context);
        ...
        // Process activity
        return $plugin->onJoomActivitiesAfterDelete($context, $table);
    }
     ...
     * @return    boolean                True on success, False on error
     */
    public function onJoomActivitiesChangeState($context, $pks, $value)
    {
        // Unalias context
        $this->unalias($context);
        ...
        // Process activity
        return $plugin->onJoomActivitiesChangeState($context, $pks, $value);
    }
    ...
    protected function getPlugin($context)
    {
        ...
        switch ($item)
        {
            case 'article':
                ...
                $class = 'plgJoomActivitiesContentArticle';
                break;

            case 'category':
                $file  = dirname(__FILE__) . '/plugins/category.php';
                $class = 'plgJoomActivitiesContentCategory';
                break;
        }
