...
require_once JPATH_PLUGINS . '/content/joomactivities/helpers/joomactivities.php';
 ...
 *
 */
class plgJoomActivitiesContentHelper
{
    /**
    ...
    protected function getHelper($name)
    {
        ...
        switch ($name)
        {
            case 'article':
                ...
                $class = 'plgJoomActivitiesContentArticleHelper';
                break;

            case 'category':
                $file  = dirname(__FILE__) . '/category.php';
                $class = 'plgJoomActivitiesContentCategoryHelper';
                break;
        }
