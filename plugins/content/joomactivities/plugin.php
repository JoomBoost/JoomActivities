 ...
 *
 */
class plgJoomActivities extends JPlugin
{
    /**
    ...
    public function __construct(&$subject, $config = array())
    {
        ...
        // Get the models
        $this->activity_model = JModelLegacy::getInstance('Activity', 'JoomActivitiesModel');
        $this->item_model     = JModelLegacy::getInstance('Item', 'JoomActivitiesModel');
     ...
     */
    public function onJoomActivitiesAfterSave($context, $table, $is_new, $store = true)
    {
     ...
     * @return    boolean                True on success, False on error
     */
    public function onJoomActivitiesAfterDelete($context, $table, $store = true)
    {
        // Break the context into its parts
        list($extension, $item_name) = explode('.', $context, 2);
     ...
     * @return    boolean                True on success, False on error
     */
    public function onJoomActivitiesChangeState($context, $pks, $value, $store = true)
    {
        // Break the context into its parts
        list($extension, $item_name) = explode('.', $context, 2);
