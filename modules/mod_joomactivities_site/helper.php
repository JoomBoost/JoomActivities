...
/**
 * Helper for mod_joomactivities_admin
 *
 */
abstract class modJoomActivitiesSiteHelper
{
    ...
    public static function getModel($config = array('ignore_request' => true))
    {
        ...
        if (!array_key_exists($cache_key, self::$model)) {
            self::$model[$cache_key] = JModelLegacy::getInstance('Activities', 'JoomActivitiesModel', $config);
        }
