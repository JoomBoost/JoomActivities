...
if ($params->get('load_jquery', 1)) {
    JHtml::_('script', 'com_joomactivities/jquery.min.js', false, true, false, false, false);
    JHtml::_('script', 'com_joomactivities/jquery.noconflict.js', false, true, false, false, false);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_joomactivities&view=module'); ?>" method="post"
    ...
    <?php if ($count) : ?>
        <fieldset>
            ...
            <?php if ($params->get('show_filter_search')) : ?>
                <div class="fltrt">
                    <input type="text" class="inputbox" placeholder="<?php echo JText::_('MOD_JOOMACTIVITIES_SITE_FILTER_SEARCH_DESC'); ?>"
    ...
    <ul id="activities-<?php echo $id; ?>">
    	...
    	<?php else : ?>
    		<li>
    			<?php echo JText::_('MOD_JOOMACTIVITIES_SITE_NO_MATCHING_RESULTS');?>
    		</li>
    	<?php endif; ?>
    </ul>
    <div class="clr" style="clear: both;"></div>
